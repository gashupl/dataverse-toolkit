...
namespace Pg.DataverseTags.Shared.Model
{
	...
	public partial class DataverseContext : Microsoft.Xrm.Sdk.Client.OrganizationServiceContext
	{
		...
		/// <summary>
		/// Gets a binding to the set of all <see cref="Pg.DataverseTags.Shared.Model.pg_tag"/> entities.
		/// </summary>
		public System.Linq.IQueryable<Pg.DataverseTags.Shared.Model.pg_tag> pg_tagSet
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
