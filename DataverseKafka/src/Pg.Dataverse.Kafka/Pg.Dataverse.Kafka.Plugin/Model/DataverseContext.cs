...
namespace Pg.Dataverse.Kafka.Plugin.Model
{
	...
	public partial class DataverseContext : Microsoft.Xrm.Sdk.Client.OrganizationServiceContext
	{
		...
		/// <summary>
		/// Gets a binding to the set of all <see cref="Pg.Dataverse.Kafka.Plugin.Model.EnvironmentVariableDefinition"/> entities.
		/// </summary>
		public System.Linq.IQueryable<Pg.Dataverse.Kafka.Plugin.Model.EnvironmentVariableDefinition> EnvironmentVariableDefinitionSet
		{
			get
			{
				return this.CreateQuery<Pg.Dataverse.Kafka.Plugin.Model.EnvironmentVariableDefinition>();
			}
		}
		
		/// <summary>
		/// Gets a binding to the set of all <see cref="Pg.Dataverse.Kafka.Plugin.Model.EnvironmentVariableValue"/> entities.
		/// </summary>
		public System.Linq.IQueryable<Pg.Dataverse.Kafka.Plugin.Model.EnvironmentVariableValue> EnvironmentVariableValueSet
		{
			get
			{
				return this.CreateQuery<Pg.Dataverse.Kafka.Plugin.Model.EnvironmentVariableValue>();
			}
		}
		
		/// <summary>
		/// Gets a binding to the set of all <see cref="Pg.Dataverse.Kafka.Plugin.Model.Task"/> entities.
		/// </summary>
		public System.Linq.IQueryable<Pg.Dataverse.Kafka.Plugin.Model.Task> TaskSet
		{
			get
			{
				return this.CreateQuery<Pg.Dataverse.Kafka.Plugin.Model.Task>();
			}
		}
	}
