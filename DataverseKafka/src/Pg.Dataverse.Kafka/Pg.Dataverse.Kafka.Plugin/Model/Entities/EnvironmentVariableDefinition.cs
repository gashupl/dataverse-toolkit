...
namespace Pg.Dataverse.Kafka.Plugin.Model
{
	...
	public partial class EnvironmentVariableDefinition : Microsoft.Xrm.Sdk.Entity
	{
		...
		public System.Collections.Generic.IEnumerable<Pg.Dataverse.Kafka.Plugin.Model.EnvironmentVariableDefinition> ReferenceDeNvDefinition_ENvDefinition
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<Pg.Dataverse.Kafka.Plugin.Model.EnvironmentVariableDefinition>("envdefinition_envdefinition", Microsoft.Xrm.Sdk.EntityRole.Referenced);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.SetRelatedEntities<Pg.Dataverse.Kafka.Plugin.Model.EnvironmentVariableDefinition>("envdefinition_envdefinition", Microsoft.Xrm.Sdk.EntityRole.Referenced, value);
			}
		}
		...
		public System.Collections.Generic.IEnumerable<Pg.Dataverse.Kafka.Plugin.Model.EnvironmentVariableValue> EnvironmentVariableDefinition_EnvironmentVariableValue
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<Pg.Dataverse.Kafka.Plugin.Model.EnvironmentVariableValue>("environmentvariabledefinition_environmentvariablevalue", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.SetRelatedEntities<Pg.Dataverse.Kafka.Plugin.Model.EnvironmentVariableValue>("environmentvariabledefinition_environmentvariablevalue", null, value);
			}
		}
		...
		public Pg.Dataverse.Kafka.Plugin.Model.EnvironmentVariableDefinition ReferencingENvDefinition_ENvDefinition
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Pg.Dataverse.Kafka.Plugin.Model.EnvironmentVariableDefinition>("envdefinition_envdefinition", Microsoft.Xrm.Sdk.EntityRole.Referencing);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.SetRelatedEntity<Pg.Dataverse.Kafka.Plugin.Model.EnvironmentVariableDefinition>("envdefinition_envdefinition", Microsoft.Xrm.Sdk.EntityRole.Referencing, value);
			}
		}
